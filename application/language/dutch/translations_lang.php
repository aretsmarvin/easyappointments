...
$lang['disable_sync_prompt'] = 'Weet je zeker dat je de kalender synchronisatie wilt uitschakelen?';
...
$lang['about_app_info'] = 'Easy!Appointments is een zeer flexibele web applicatie waarmee klanten afspraken met u kunnen boeken via het web. Bovendien biedt het de mogelijkheid om uw gegevens te synchroniseren met Google Agenda, zodat u ze kunt gebruiken met andere diensten.';
...
$lang['about_app_license'] = 'Easy!Appointments is gelicenseerd onder de gplv3 licentie. Door het gebruik van de code van Easy Afspraken op welke manier dan ook gaat u akkoord met de in de volgende url beschreven voorwaarden:';
...
$lang['time_format_hint'] = 'Verander de tijdnotatie (H - Uren, M - Minuten).';
$lang['first_weekday'] = 'Eerste dag van de week';
$lang['first_weekday_hint'] = 'Stel de eerste dag van de kalender week in.';
...
$lang['reset_working_plan'] = 'Reset werkplan naar de standaard waardes.';
...
$lang['website_using_cookies_to_ensure_best_experience'] = 'Deze website gebruikt cookies, om de beste website ervaring te geven.';
...
$lang['delete_personal_information_hint'] = 'Verwijder al je afspraken en persoonlijke data uit het systeem.';
$lang['delete_personal_information'] = 'Verwijder persoonlijke informatie';
$lang['delete_personal_information_prompt'] = 'Weet je zeker dat je al je persoonlijke informatie wilt verwijderen? Dit kan niet ongedaan gemaakt worden.';
$lang['location'] = 'Locatie';
$lang['working_plan_exception'] = 'Werkplan uitzondering';
$lang['working_plan_exceptions'] = 'Werkplan uitzonderingen';
$lang['working_plan_exceptions_hint'] = 'Voeg een werkplan uizonderingsdag toe, buiten het werkplan om.';
$lang['new_working_plan_exception_title'] = 'Nieuwe werkplan uitzondering';
$lang['working_plan_exception_saved'] = 'Werkplan uitzondering succesvol opgeslagen.';
$lang['working_plan_exception_deleted'] = 'Werkplan uitzondering succesvol verwijderd.';
$lang['add_working_plan_exceptions_during_each_day'] = 'Voeg een werkplan uizonderingsdag toe, buiten het werkplan om..';
$lang['add_working_plan_exception'] = 'Voeg werkplan uitzondering toe';
$lang['require_phone_number'] = 'Stel telefoonnummer verplicht';
$lang['require_phone_number_hint'] = 'Wanneer ingeschakeld, moeten klanten en gebruikers hun telefoonnumer invoeren tijdens het boeken van een afspraak.';
$lang['check_spam_folder'] = 'Controleer alsjeblieft de spamfolder, wanneer je de email niet binnen een paar minuten hebt ontvangen.';
$lang['api_token_hint'] = 'Stel een geheim token in, om token based authenticatie in te schakelen voor de Easy!Appointments API.';
$lang['timezone'] = 'Tijdzone';
$lang['overwrite_existing_working_plans'] = 'Dit zal het bestaande werkplan overschrijven, weet je zeker dat je door wilt gaan?';
$lang['working_plans_got_updated'] = 'Alle werkplannen zijn geüpdatet.';
$lang['apply_to_all_providers'] = 'Pas op alle providers toe';
...
$lang['disable_booking'] = 'Boekingen uitschakelen';
$lang['disable_booking_hint'] = 'De boekingspagina zal worden uitgeschakeld, zolang deze instelling actief is. Klanten kunnen geen nieuwe afspraken maken.';
$lang['display_message'] = 'Display Message';
$lang['booking_is_disabled'] = 'Boekingen zijn uitgeschakeld!';
$lang['appearance'] = 'Uitstraling';
$lang['company_logo'] = 'Bedrijfslogo';
$lang['company_logo_hint'] = 'Het bedrijfslogo zal op veel plaatsen in de app weergegeven worden, waaronder de boekingspagina en de notificatie emails (afbeelding, max 2MB).';
$lang['company_color'] = 'Bedrijfskleur';
$lang['company_color_hint'] = 'De bedrijfskleur zal toegepast worden door de hele app, zodat het jouw branding gebruikt.';
$lang['localization'] = 'Localization';
$lang['integrations'] = 'Integraties';
$lang['company'] = 'Bedrijf';
$lang['remove'] = 'Verwijder';
$lang['login_button'] = 'Login Knop';
$lang['display_login_button_hint'] = 'Bepaalt of de login knop weergegeven wordt op de boekingspagina.';
$lang['private'] = 'Prive';
$lang['private_hint'] = 'Prive records worden niet weergegeven of verwerkt in publieke paginas, zoals de boekingspagina.';
$lang['reset'] = 'Herstel';
$lang['all'] = 'Alle';
$lang['booking_link'] = 'Boekingslink';
$lang['add_new_event'] = 'Voeg nieuwe gebeurtenis toe';
$lang['what_kind_of_event'] = 'Wat voor soort gebeurtenis wil je toevoegen?';
$lang['theme'] = 'Thema';
$lang['limit_customer_access'] = 'Beperk klant toegang';
$lang['limit_customer_access_hint'] = 'Wanneer ingeschakeld, hebben providers en secretarissen alleen toegang tot de klanten waar ze een afspraak mee hebben.';
$lang['url'] = 'URL';
$lang['secret_token'] = 'Geheim Token';
$lang['verify_ssl'] = 'Verifieer SSL';
